...
export class DinamicosComponent  { // Implementa OnInit
  ...
  borrar( i: number ) { // i es el índice del elemento a borrar
    this.favoritosArr.removeAt(i); // removeAt() es un método de FormArray para eliminar un elemento del array.
  }
